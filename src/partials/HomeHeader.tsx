...
export default function HomeHeader() {
    return (
        <div className=" min-h-screen overflow-hidden relative">
            ...
            <div className="absolute min-h-full min-w-full bg-black/75 top-0 left-0 flex flex-col justify-center items-center p-5 pb-28">
                <Image
                    src={'/images/logo.png'}
                    alt="Logo"
                    width={150}
            ...
            <div className="absolute h-44 w-full lg:bottom-5 left-0 bottom-0">
